...
if (function_exists('register_sidebar')) {
    register_sidebar(
        array(
        'name' => 'Footer Quick Link column 3',
        'id' => 'footer_quick_link_colum_3',
        'description' => 'Widget Area for Footer Quick Link 3column',
        'before_widget' => '<div class="col-md-3"><div class="footer_widget padding_top_60 padding_bottom_60">',
        'after_widget' => '</div></div>',
        )
    );
}
                         
	class wclacrosse_quick_links extends WP_Widget
	{
	/**
	...
	{
		parent::__construct(false, $name = "WCL: Quick Links col-3 ", array("description" => "Footer Quick Links col-md-3 width will be here."));
	}
...
add_action('widgets_init', create_function('', 'return register_widget("wclacrosse_quick_links");'));
